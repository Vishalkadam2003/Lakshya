...
function LeadNDA() {
    ...
    const onSubmit = async (data) => {
        ...
        try {
            const response = await fetch("http://localhost:5000/api/nda", {
                method: "POST",
                ...
                <div className="w-full max-w-5xl bg-white/40 backdrop-blur-xl shadow-2xl rounded-2xl p-10 border border-white/50">
                    ...
                    <form onSubmit={handleSubmit(onSubmit)} className="space-y-8">
                        ...
                        <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                            ...
                            <div>
                                <label className="block text-sm font-semibold text-gray-700">Road</label>
                                <input
                                    {...register("road", { required: true })}
                                    type="text"
                                    className="w-full mt-2 p-3 rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none"
                                />
                                {errors.road && <p className="text-red-500 text-sm mt-1">Road is required</p>}
                            </div>
                            ...
                            <div>
                                ...
                                <input
                                    ...
                                    className="w-full mt-2 p-3 rounded-xl border border-gray-300 shadow-sm focus:ring-2 focus:ring-indigo-400 focus:outline-none"
                                />
                                {errors.pincode && <p className="text-red-500 text-sm mt-1">Pincode is required</p>}
                            </div>
                        </div>
